...
5. Move/lock each window independently; enable click-through; change icon size, opacity, colors, name/target/GCD visibility; reset positions; reload. Use preview for empty windows, then disable it.
